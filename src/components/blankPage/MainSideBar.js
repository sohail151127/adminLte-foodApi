  ...
  return (
    ...
    <div className="sidebar">
      ...
      <div className="user-panel mt-3 pb-3 mb-3 d-flex">
        <div className="image">
          <img src={require('../img/user2-160x160.jpg')} className="img-circle elevation-2" alt="User" />
        </div>
        <div className="info">
         ...
         with font-awesome or any other icon font library */}
          <li className="nav-item">
            ...
            <ul className="nav nav-treeview">
              ...
              <li className="nav-item">
                <Link to="/HomePge" className="nav-link">
                  <i className="far fa-circle nav-icon" />
                  <p>Dashboard v2</p>
                </Link>
              </li>
              <li className="nav-item">
                <Link to="/HomePage" href="../../index3.html" className="nav-link">
                  <i className="far fa-circle nav-icon" />
                  <p>Dashboard v3</p>
                </Link>
              </li>
